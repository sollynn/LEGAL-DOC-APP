...
export const generateDpaWord = async (values) => {
  try {
     ...
     * ตรงกับ P46, P48–P50, P52–P54, P56–P57, P62 ในเอกสารต้นฉบับ
     */
     ...
     * ตรงกับ P58–P61 (รายละเอียดการละเมิด)
     */
     ...
     * ตรงกับ P47 (ข้อ 2), P51 (ข้อ 6), P55 (ข้อ 10)
     */
    ...
    const doc = new Document({
      numbering: {
        config: [
          {
            // กระสุนหลัก (ข้อ 1–9 และ 11–13)  →  "-" ย่อหน้า firstLine 360
          ...
          {
            // กระสุนย่อย (รายละเอียดการละเมิด ข้อ 12) → "-" ไม่มี indent พิเศษ
      ...
      sections: [
        {
          ...
          children: [
            ...
            // ── ข้อ 2 (continuation – firstLine=360) ─────────────────────
            continuationPara([
            ...
            // ── ข้อ 6 (continuation – firstLine=567) ─────────────────────
            continuationPara([
            ...
            // ── ข้อ 10 (continuation – firstLine=360) ────────────────────
            continuationPara([
